...
<div class="container top">
  <div class="row">
    ...
    <div class="col-xl-12">
      ...
      {
        ?>
        <p class="msg success">We <?=ucfirst($_GET["verb"])?> Your Team Successfully</p>
        <?php
      }?>
    
  
      <div class="action">
        <a href="teamForm.php" class="btn btn-success margin-bottom"><i class="fas fa-plus-circle"></i> Manage Team</a>
      </div>
      </div>
