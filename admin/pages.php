...
<div class="container top">
  <div class="row">
    ...
    <div class="col-xl-12 margin-less">
      <div class="center margin image ">
      ...
      <div class="action">
        <a href="pageForm.php" class="btn btn-success margin-bottom"><i class="fas fa-plus-circle"></i> Add Page</a>
      </div>
      </div>
