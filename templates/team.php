    ...
    <div class="container-fluid col-xl-12">
        <div class="row">
            <div class="wrapper">
                ...
                <div class="content new-margin latest-properties">
                    <h2 class="text-center margin-bottom new-size"><?=$arrPageDetails["strMainTitle"]?></h2>
                ...
                <div class="row">
                <div class="col-xl-12">
                    <h2 class="text-center margin-bottom"><?=$arrPageDetails["strHeaderTitle"]?></h2>
                </div>
            </div>
        </div>
